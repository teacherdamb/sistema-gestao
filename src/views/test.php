                          ...
                          <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1000">
                            <form action="formulario.php" method="POST">
                              <div class="mb-3">
                                ...
                                <input class="form-control" name="email" id="email" for="email" type="email" placeholder="name@example.com">
                              </div>
                              <div class="mb-3">
                                <label class="form-label" for="exampleFormControlTextarea1">Example textarea</label>
                                <textarea class="form-control" name="message" id="messasge" for="message" rows="3"></textarea>
                              </div>
                              <div>
                                  <button class="btn btn-success" type="submit" name="submit" id="submit" style="color: white;">Enviar</button>
                              </div>
                            </form>
                          </div>
                        </div>
